...
System.out.println(MasterData.asJsonString(developmentDto));
	...
	public void testGetAllDevelopmentsByPoliticalLeaderId() throws Exception {
		LeaderDevelopmentDto developmentDtos = MasterData.getDevelopmentLeaderDtoList();

		when(this.developmentService.getDevByLeader(1L)).thenReturn(developmentDtos);
	...
	public void testGetAllDevelopmentsByPoliticalLeaderIdIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		LeaderDevelopmentDto developmentDtos = MasterData.getDevelopmentLeaderDtoList();
		developmentDtos.getLeader().setPoliticalLeaderId(1L);
		
		when(this.developmentService.getDevByLeader(1L)).then(new Answer<LeaderDevelopmentDto>() {

			@Override
			public LeaderDevelopmentDto answer(InvocationOnMock invocation) throws Throwable {
				// TODO Auto-generated method stub
				count[0]++;
